...
describe Nis::Util::Serializer do
  ...
  let(:fix_private_key) { '983bb01d05edecfaef55df9486c111abb6299c754a002069b1d0ef4537441bda' }
  let(:transaction) do
    {
      timeStamp: 9111526,
  ...
  it { expect(subject.fix_private_key(private_key)).to eq fix_private_key }
